...
GROUP_DATA = {
    "Group 1": {"brand": "Starry Empress", "duration": "12-Day Mediterranean Trip", "theme": "Gourmet Food & Spa Focus", "market": "WESTERN Market (High bar spend, wants slow lazy holiday)", "map": "USA Miami -> Sailing Caribbean Sea -> Mexico Cozumel"},
    "Group 2": {"brand": "Oceanic Voyager", "duration": "14-Day Caribbean Holiday", "theme": "High-Energy Sports & Deck Parties", "market": "WESTERN Market (Mass family, high casino spend, active fun)", "map": "USA Seattle -> Sailing Gulf of Alaska -> USA Juneau"},
    "Group 3": {"brand": "Royal Sovereign", "duration": "16-Day Long Ocean Crossing", "theme": "History, Local Culture & Sightseeing", "market": "WESTERN Market (Rich premium travelers, fine dining)", "map": "Spain Barcelona -> Sailing Mediterranean Sea -> France Marseille"},
    "Group 4": {"brand": "Genting Splendor", "duration": "18-Day Southeast Asia Trip", "theme": "Asian Michelin Dim Sum Food Tour", "market": "ASIAN Market (Big families, delicious food, Safety First)", "map": "Singapore Base -> Sailing Andaman Sea -> Thailand Phuket"},
    "Group 5": {"brand": "Coral Majestic", "duration": "21-Day Long Cruise Route", "theme": "Business Meetings & Tech Networking", "market": "WESTERN Market (Adventure travelers, loves outdoor tours)", "map": "Australia Sydney -> Sailing Tasman Sea -> New Zealand Auckland"},
    "Group 6": {"brand": "Horizon Dragon", "duration": "24-Day Big Asia Transit", "theme": "Lunar New Year Festival Cruise", "market": "ASIAN Market (Hong Kong high-end rich shoppers, hates delays)", "map": "Hong Kong Base -> Sailing East China Sea -> Japan Okinawa"},
    "Group 7": {"brand": "Atlantic Crown", "duration": "27-Day Coastline Tour", "theme": "Big Family Vacation & Kids Activities", "market": "WESTERN Market (Older alumni groups, wants lectures)", "map": "Denmark Copenhagen -> Sailing Baltic Sea -> Finland Helsinki"},
    "Group 8": {"brand": "Pacific Pacific", "duration": "29-Day Deep Wilderness Expedition", "theme": "Diving, Coral Reefs & Sea Nature", "market": "ASIAN Market (Singapore segment, wildlife photography tours)", "map": "Japan Yokohama -> Sailing North Pacific -> Taiwan Keelung"}
}

# --- PHASE 0: CORPORATE INITIAL REGISTRATION ---
...
# --- PHASE 1 - 5: SIMULATION BALLOT ROULETTE ---
    ...
    with col_left:
        ...
        # Pre-declare runtime strategy variables to guarantee rendering safety across environments
